...
using QualRazorLib.Controls.Tables.Informations;
...
{
    public class QualTablePagenation<TModel> : QualRazorComponentBase, ITableInformationContent where TModel : class
    {
